...
export function MembersDashboard() {
  ...
  useEffect(() => {
    const id = window.setInterval(() => {
      setCountdown((c) => {
        let { seconds, minutes, hours, days } = c
        seconds -= 1
        if (seconds < 0) {
          seconds = 59
          minutes -= 1
        ...
        if (days < 0) return initialCountdown
        ...
        <div className="overflow-hidden rounded-xl border border-white/10 bg-charcoal/25 shadow-[0_0_0_1px_rgba(255,255,255,0.02)]">
          <div className="flex min-h-[min(70vh,720px)] flex-col lg:min-h-[640px] lg:flex-row">
            ...
            <div className="flex min-w-0 flex-1 flex-col">
              ...
              <MembersMobileNav activeId="dashboard" onSelect={() => setMenuOpen(false)} />
              ...
              <div className="min-w-0 flex-1 overflow-x-hidden overflow-y-auto">
                <div className="min-w-0 space-y-4 p-4 sm:space-y-5 sm:p-5 md:p-6">
                    ...
                    <section className="relative overflow-hidden rounded-xl border border-white/10">
                      ...
                      <div className="relative z-10 px-5 py-8 sm:px-8 sm:py-10 md:px-10 md:py-12">
                        ...
                        <p className="mt-3 max-w-xl font-garamond text-base leading-relaxed text-mist/65 sm:mt-4 sm:text-lg">
                          You&apos;re part of a community built for serious drummers. Show up,
                          participate, and let the work compound.
                        </p>
                        <button type="button" className={`${goldBtn} mt-5 w-full sm:mt-6 sm:w-auto`}>
                          <PlayIcon />
                          Continue Your Path
                        </button>
                      </div>
                  ...
                  <div className="grid min-w-0 grid-cols-1 gap-4 sm:gap-5 lg:grid-cols-2">
                      ...
                      <div className="grid min-w-0 max-w-full grid-cols-1 gap-5 text-center md:grid-cols-[auto_minmax(0,1fr)] md:items-start md:gap-4 md:text-left">
                        ...
                        <div className="min-w-0 max-w-full space-y-2 break-words">
                          <p className="font-garamond text-xs tracking-[0.2em] text-gold/80 uppercase sm:text-sm">
                            Upcoming Live Cohort
                          </p>
                          <h3 className="font-garamond text-lg font-medium leading-snug text-mist md:text-xl">
                            Live Session with Mike Malinin
                          </h3>
                          <p className="font-garamond text-base leading-relaxed text-mist/55">
                            Building Confidence Behind the Kit &amp; On Stage
                          </p>
                          <p className="pt-1 font-garamond text-sm text-mist/45">
                            May 29, 2026 · 7:00 PM ET
                          </p>
                          <a
                            href="#"
                            className="inline-block font-garamond text-sm text-gold underline decoration-gold/35 underline-offset-2"
                          >
                            Zoom Meeting
                          </a>
                          <button
                            type="button"
                            className={`${goldBtn} mt-3 box-border w-full max-w-full md:mt-4 md:w-auto`}
                          >
                            Join Session
                          </button>
                        </div>
                    ...
                    <MembersCard title="Session Vault" className="min-w-0 overflow-hidden">
                      <div className="flex snap-x snap-mandatory gap-3 overflow-x-auto pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                        {sessionVaultItems.map((item) => (
                          <button
                            key={item.title}
                            type="button"
                            className="w-[8.5rem] shrink-0 snap-start text-left sm:w-36"
                          >
                      ...
                      <div className="flex gap-2 overflow-x-auto pb-0.5 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                        {vaultFilters.map((f) => (
                          <button
                            ...
                            className={`shrink-0 rounded-full px-3 py-1.5 font-garamond text-sm transition ${
                              vaultFilter === f
                  ...
                  <div className="grid min-w-0 grid-cols-1 gap-4 sm:gap-5 lg:grid-cols-2 xl:grid-cols-3">
                    ...
                    <MembersCard title="Community Feed" className="lg:col-span-1 xl:col-span-1">
                            ...
                            <div className="flex gap-3">
                              ...
                              <div className="min-w-0 flex-1">
                                <div className="flex items-baseline justify-between gap-2">
                                  ...
                                  <span className="shrink-0 font-garamond text-sm text-mist/40">
                                    {post.time}
                                  </span>
                                </div>
                    ...
                    <MembersCard title="Ask Mike" className="xl:col-span-1">
                  ...
                  <MembersCard>
                    <div className="flex items-center gap-4">
                      ...
                      <div className="min-w-0">
                        ...
                        <h3 className="mt-1 font-garamond text-lg font-medium text-mist">
                          May Groove Challenge
                        </h3>
                        <p className="mt-1 font-garamond text-base text-mist/50">Starts May 20</p>
                      </div>
                    </div>
                  </MembersCard>
                </div>
